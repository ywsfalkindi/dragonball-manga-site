...
>
    ...
    {#if manga.status === 'مستمرة'}
        <span
            class="rounded-full px-2.5 py-1 text-xs font-bold text-white shadow-md bg-blue-500"
        >
            مستمرة
        </span>
    {:else if manga.status === 'مكتملة'}
        <span
            class="rounded-full px-2.5 py-1 text-xs font-bold text-white shadow-md bg-green-600"
        >
            مكتملة
        </span>
    {:else if manga.status === 'متوقفة'}
        <span
            class="rounded-full px-2.5 py-1 text-xs font-bold text-white shadow-md bg-red-500"
        >
            متوقفة
        </span>
    {/if}
    ...
    {#if manga.chapters_count && manga.chapters_count > 0}
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                <path d="M9 2a1 1 0 00-1 1v1a1 1 0 002 0V3a1 1 0 00-1-1zM6 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zM3 9a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 13a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" />
            </svg>
