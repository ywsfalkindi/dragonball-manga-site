...
<div class="p-8 font-[Tajawal] bg-gray-900 min-h-screen text-white">
	<a href="/admin/mangas" class="text-blue-400 hover:underline mb-8 block text-right">&larr; العودة لإدارة المانجا</a>
		...
		>
			...
			<div class="pt-4 border-t border-gray-700">
				...
				<div>
					...
					/>
					<p class="text-xs text-gray-400 mt-1">
						اسم المجلد الذي يحتوي فصول المانجا. مثال: "dbs".
					</p>
				</div>
				<div class="mt-4">
					...
					/>
					<p class="text-xs text-gray-400 mt-1">
						الجزء الثابت من اسم ملف الصفحة. مثال: "dbs".
					</p>
				</div>
			</div>
			...
			<button
				type="submit"
				class="w-full bg-green-600 text-white font-bold py-3 px-4 rounded hover:bg-green-700"
			>
				حفظ المانجا
			</button>
		</form>
